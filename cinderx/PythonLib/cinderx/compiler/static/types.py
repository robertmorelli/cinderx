...
class TypeEnvironment:
    def __init__(self) -> None:
        ...
        if spamobj is not None:
            self.spam_obj: GenericClass | None = GenericClass(
                GenericTypeName(
    ...
    def _builtin_exception_class(
        self, exception_type: type[object], base: Class | None = None
    ) -> Class:
        if base is None:
            base = self.exception
        return Class(
...
class Value:
    ...
    def bind_attr(
        self, node: ast.Attribute, visitor: TypeBinder, type_ctx: Class | None
    ) -> None:
        visitor.set_type(
            node,
...
class ClassCallInfo:
    def __init__(
        self, new: ArgMapping | None, init: ArgMapping | None, dynamic_call: bool
    ) -> None:
        self.new = new
        self.init = init
...
class Class(Object["Class"]):
    ...
    def __init__(
        ...
        self._mro: list[Class] | None = None
    ...
    def _get_bases(self, bases: list[Class] | None) -> list[Class]:
        if bases is None:
    ...
    def resolve_name(self, name: str) -> Value | None:
    ...
    @property
    def generic_type_def(self) -> Class | None:
    ...
    def _resolve_dunder(self, name: str) -> tuple[Class, Value | None]:
    ...
    def bind_call(
        ...
        new_mapping: ArgMapping | None = None
        init_mapping: ArgMapping | None = None
    ...
    def find_slot(self, node: ast.Attribute) -> Slot[Class] | None:
        for base in self.mro:
            member = base.members.get(node.attr)
            if (
                member is not None
    ...
    def get_own_member(self, name: str) -> Value | None:
        return self.members.get(name)

    def get_parent_member(self, name: str) -> Value | None:
    ...
    def get_member(self, name: str) -> Value | None:
...
class GenericClass(Class):
    ...
    def __init__(
        ...
        type_env: TypeEnvironment,
        bases: list[Class] | None = None,
        instance: Object[Class] | None = None,
        klass: Class | None = None,
        members: dict[str, Value] | None = None,
        type_def: GenericClass | None = None,
        is_exact: bool = False,
        pytype: type[object] | None = None,
        is_final: bool = False,
        has_init_subclass: bool = False,
...
class CType(Class):
    ...
    def __init__(
        ...
        type_env: TypeEnvironment,
        bases: list[Class] | None = None,
        instance: CInstance[Class] | None = None,
        klass: Class | None = None,
        members: dict[str, Value] | None = None,
        is_exact: bool = True,
        pytype: type[object] | None = None,
...
class ArgMapping:
    def __init__(
        ...
        self.kwargs: list[tuple[str | None, ast.expr]] = [
...
class FunctionContainer(Object[Class]):
    def bind_function(
        self, node: FunctionDef | AsyncFunctionDef, visitor: TypeBinder
    ) -> None:
...
class Callable(Object[TClass]):
    def __init__(
        ...
        func_name: str,
        module_name: str,
        args: list[Parameter] | None,
        args_by_name: dict[str, Parameter],
        num_required_args: int,
        vararg: Parameter | None,
        kwarg: Parameter | None,
        return_type: TypeRef,
    ) -> None:
        super().__init__(klass)
        self.func_name = func_name
        self.module_name = module_name
        self.container_type: Class | None = None
        self.args = args
...
class AwaitableType(GenericClass):
    def __init__(
        self,
        type_env: TypeEnvironment,
        type_name: GenericTypeName | None = None,
        type_def: GenericClass | None = None,
        is_exact: bool = False,
    ) -> None:
        super().__init__(
...
class DecoratedMethod(FunctionContainer):
    ...
    @property
    def node(self) -> FunctionDef | AsyncFunctionDef:
        return self.real_function.node

    @property
    def container_type(self) -> Class | None:
...
class DataclassField(Object[DataclassFieldType]):
    def __init__(
        ...
        default_factory: AST | None = None,
        init: bool = True,
        repr: bool = True,
        hash: bool | None = None,
        compare: bool = True,
        metadata: AST | None = None,
        kw_only: bool = False,
    ) -> None:
        super().__init__(klass)
        ...
        self.base_class: Dataclass | None = None
        self.default_class: Dataclass | None = None
...
class Dataclass(Class):
    ...
    def emit_dunder_delattr_or_setattr(
        ...
        graph.emit_prologue()
        graph.emit("LOAD_FAST", "self")
        # TASK(T92470300): graph.emit("CAST", (self.exact_type().type_descr, False))
        graph.emit("LOAD_TYPE")
...
class Slot(Object[TClassInv]):
    ...
    def __init__(
        ...
        self.override: Slot[Class] | None = None

    def update(self, assignment: AST | None, declared_on_class: bool) -> None:
    ...
    def can_override(self, override: Value, klass: Class, module: ModuleTable) -> bool:
        if isinstance(override, Slot):
            ...
            if self.is_typed_descriptor_with_default_value():
                # Attributes declared on the class are overloadable properties.
...
class ExtremumFunction(Object[Class]):
    ...
    def emit_call(self, node: ast.Call, code_gen: StaticCodeGenBase) -> None:
        if (
            ...
            # TASK(T216868868): Code generation here needs to be redone for 3.12
...
class IsInstanceEffect(NarrowingEffect):
    ...
    def _refine_type(
        self,
        type_state: TypeState,
        type_state_nodes: dict[str, ast.AST] | None,
        to: Value,
    ) -> None:
...
class UnionTypeName(GenericTypeName):
    ...
    @property
    def float_type(self) -> Class | None:
...
class UnionType(GenericClass):
    ...
    def __init__(
        self,
        type_env: TypeEnvironment,
        type_name: UnionTypeName | None = None,
        type_def: GenericClass | None = None,
        instance_type: type[Object[Class]] | None = None,
...
class CIntInstance(CInstance["CIntType"]):
    ...
    def validate_mixed_math(self, other: Value) -> Value | None:
